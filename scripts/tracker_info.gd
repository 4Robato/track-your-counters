...
func _init(
	m1 : int = 1,
	m1_type : OperatorButton.BUTTON_TYPE = OperatorButton.BUTTON_TYPE.PLUS,
	m2 : int = 3,
	m2_type : OperatorButton.BUTTON_TYPE = OperatorButton.BUTTON_TYPE.PLUS,
	p1 : int = 5,
	p1_type : OperatorButton.BUTTON_TYPE = OperatorButton.BUTTON_TYPE.PLUS,
	p2 : int = 1,
	p2_type : OperatorButton.BUTTON_TYPE = OperatorButton.BUTTON_TYPE.MINUS,
	_name : String = "",
	value : int = 0,
